<fieldset>
        <div class="row">
            ...
            <div class="col-md-4">
              <label for="patient1_facility"><br>#1 Medicatin Pickup Point</label>
            ...
            <div class="col-md-4">
              <label for="patient2_facility"><br>#2 Medicatin Pickup Point</label>
            ...
            <div class="col-md-6">
              <label for="pregnant"><br>Anyone pregnant in the house?</label>
                <div style="width:98%">
                <select name="pregnant" size="1" id="pregnant" class="form-control unit" value="<?php echo $edit ? $user_id['pregnant'] : ''; ?>" required>
                    <option selected>Choose...</option>
                    <option>No</option>
                    <option>Yes</option>
                </select>
