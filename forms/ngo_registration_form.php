        ...
        <div class="row">
            ...
            <div class="col-md-12">
              <label for="organization_structure">Registration Number</label>
                <input class="form-control" type="text" name="organization_structure" id="example-text-input" placeholder="Please enter a valid NPO Registration Number" required> 
            </div>


            <div class="col-md-12">
              <label for="organization_name">Registered Name</label>
                <input class="form-control" type="text" name="organization_name" id="example-text-input" placeholder="Please enter a valid NPO Registration Name" required> 
            </div>
            ...
            <div class="col-md-6">
              <label for="firstname">First Names</label>
                <input class="form-control" type="text" name="firstname" id="example-text-input" placeholder="Please enter your first names" required> 
            </div>


            <div class="col-md-6">
              <label for="lastname">Surname</label>
                <input class="form-control" type="text" name="lastname" id="example-text-input-2" placeholder="Please enter your surname" required> 
            </div>


            <div class="col-md-12">
              <label for="username">Identification Number</label>
                <input class="form-control" type="text" name="username" id="example-text-input" placeholder="Please enter your unique identification number" required> 
              </div>   
            ...
            <div class="col-md-6">
              <label for="cpassword">Repeat password</label>
                <input type="password" class="form-control" name="cpassword" id="exampleInputPassword2" placeholder="Please enter your password again" required> 
            </div>
          </div>
