<fieldset>
        <div class="row">
            ...
            <div class="col-md-3">
              <label for="males_in_house"># Males</label>
                <div style="width:98%">
            ...
            <div class="col-md-3">
              <label for="intersex_in_house"># Intersex</label>
                <div style="width:98%">
                <select name="intersex_in_house" size="1" id="intersex_in_house" class="form-control unit" value="<?php echo $edit ? $user_id['intersex_in_house'] : ''; ?>" required>
                    <option selected>Choose...</option>
                    <option>0</option>
                    <option>1</option>
                    <option>2</option>
            ...
            <div class="col-md-3">
              <label for="num_hetero_sex"># Heterosexual</label>
                <div style="width:98%">
