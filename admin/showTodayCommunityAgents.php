...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-secondary">Community Members Registered Today</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Community Members  Registered Users</h4>
        ...
        <?php
            $sql="SELECT * FROM users where network='C' and date(date)=CURDATE()";
