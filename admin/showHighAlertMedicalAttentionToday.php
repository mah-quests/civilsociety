                    ...
                    <div class="row page-titles">
                            <div class="col-md-12 align-self-center" align="center">
                                <h3 class="text-secondary">
                                    High Alert Medical Attention Today
                                </h3>
                            </div>
                    </div>
                </center>
...
<?php
    $sql="SELECT * from users_orders WHERE date(date)= CURDATE() and unique_code in (SELECT unique_code FROM request_medication_02 WHERE essential_services_worker='Yes' or healthCareCondition='Yes' or emegencyCondition='Yes' and (highTempCond='Yes' and dryCoughCond='Yes') or (shortBreathConditionCond='Yes')) ";
...
<?php
    $sql="SELECT * from users_orders WHERE date(date)= CURDATE() and unique_code in (SELECT unique_code FROM `request_medication_01` WHERE `chronic_medication`='Yes') ";
    $query=mysqli_query($db,$sql);
