...
?>
                    ...
                    <div class="row page-titles">
                            <div class="col-md-12 align-self-center" align="center">
                                <h3 class="text-secondary">
                                    Household Members Who Possible Require Shelter
                                </h3> 
                            </div>
                    </div>
                </center>            
  ...
  <div class="card" id="list-of-violations">
      <div class="card-body">
          <h4 class="card-title">LGBTQ+ and Community Violations</h4>
...
<?php
    $sql="select * from users_orders where unique_code in (SELECT unique_code FROM request_violations where communityMemberType = 'Discrimination' or communityMemberCond = 'Discrimination') ";
    $query=mysqli_query($db,$sql);

    if(!mysqli_num_rows($query) > 0 ){
        echo '<td colspan="8"><center>No Households Violations Recorded!</center></td>';
    } else {        
...
<?php
    $sql="select * from users_orders where unique_code in (SELECT unique_code FROM request_violations where communityMemberType = 'Stigma' or communityMemberCond = 'Stigma') ";
    $query=mysqli_query($db,$sql);
...
<?php
    $sql="select * from users_orders where unique_code in (SELECT unique_code FROM request_violations where communityMemberType = 'Domestic violence' or communityMemberCond = 'Domestic violence') ";
    $query=mysqli_query($db,$sql);
...
<?php
    $sql="select * from users_orders where unique_code in (SELECT unique_code FROM request_violations where communityMemberCond = 'Yes') ";
    $query=mysqli_query($db,$sql);
