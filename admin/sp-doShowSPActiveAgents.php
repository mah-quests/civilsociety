...
?>
        ...
        <?php
            $sql="SELECT * FROM users WHERE address LIKE '%soweto%' and u_id in
                (select distinct u_id from users_orders)";
            $query=mysqli_query($db,$sql);

            $sql2="SELECT * FROM users WHERE address LIKE '%roodepoort%' and
            u_id in (select distinct u_id from users_orders) ";
