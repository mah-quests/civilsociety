        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Print Violations Registered Yesterday</h3> </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Violations Yesterday</h4>
        ...
        $sql="select * from request_by_partner where unique_code in 
                (SELECT unique_code FROM `request_violations` WHERE any_kind_abuse ='Yes' and date(date) = curdate() - interval 1 day)
            ";
