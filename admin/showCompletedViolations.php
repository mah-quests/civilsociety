        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-12 align-self-center">
                    <h3 class="text-secondary">List of all processed and completed violation requests</h3> 
                </div>
...
<?php
    $sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id where users_orders.status='closed' and users_orders.unique_code in (SELECT unique_code FROM request_violations where  any_kind_abuse='Yes' )";
