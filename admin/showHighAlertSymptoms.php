...
?>
  ...
  <div class="card" id="list-of-violations">
      <div class="card-body">
          <h4 class="card-title">People showing possible symptoms of COVID-19 (cough, fever and shortness of breath combination)</h4>
...
<?php
    $sql="SELECT * from users_orders where unique_code in (SELECT unique_code FROM request_medication_02 WHERE (shortBreathConditionCond='Yes' and dryCoughCond='Yes') or (highTempCond='Yes' and dryCoughCond='Yes') or (shortBreathConditionCond='Yes' and dryCoughCond='Yes')) ";
