                    ...
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                                ...
                                $sql="SELECT * FROM `users` WHERE provice='Eastern Cape' and district in
                                          ('Buffalo City Metropolitan', 'Buffalo city Municipality') order by district";
                                $query=mysqli_query($db,$sql);

                                $sql2="SELECT * FROM `users` WHERE provice='Eastern Cape' and district in
                                           ('Nelson Mandela Bay Metropolitan') order by district";
                                $query2=mysqli_query($db,$sql2);

                                $sql3="SELECT * FROM `users` WHERE provice='Eastern Cape' and district in
                                           ('O.R.Tambo', 'OR Tambo', 'OR Tambo District Municipality') order by district";
                                $query3=mysqli_query($db,$sql3);

                                $sql4="SELECT * FROM `users` WHERE provice='Eastern Cape' and district in
                                           ('Chris Hani', 'Chris Hani District Municipality') order by district";
