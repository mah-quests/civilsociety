...
?>
  ...
  <div class="card" id="list-of-violations">
      <div class="card-body">
          <h4 class="card-title">Less Than 2 People Working & More Than 5 People In The House</h4>
...
?>
  ...
  <div class="card" id="list-of-violations">
      <div class="card-body">
          <h4 class="card-title">Less Than 2 People Working & More Than 1 People Pregnant</h4>
...
?>
  ...
  <div class="card" id="list-of-violations">
      <div class="card-body">
          <h4 class="card-title">Less Than 2 People Working & More Than 0 People Who Is Disabled</h4>
