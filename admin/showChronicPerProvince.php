...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-secondary">Household with Disabled Persons</h3>
        </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <?php if (!empty($_GET)) {
                        ?>
                            <h4 class="card-title">Number of people with Chronic illnesses in <?php echo $_GET['id']; ?></h4>
                        ...
                        <div class="table-responsive m-t-40">
                            ...
                            if ($input == "unallocated"){
                                $sql="SELECT * FROM users_orders where (province in ('$province', '$province2') or province is null) and unique_code in (SELECT unique_code from request_medication_01 where chronic_medication = 'Yes')";
                                $query=mysqli_query($db,$sql);

                                $sql2="SELECT * FROM users_orders where (province in ('$province', '$province2') or province is null) and unique_code in (SELECT unique_code from request_medication_01 where chronic_medication > 0)";
                                $query2=mysqli_query($db,$sql2);

                            } else {
                                $sql="SELECT * FROM users_orders  where province like '$province' and unique_code in (SELECT unique_code from request_medication_01 where chronic_medication = 'Yes')";
                                $query=mysqli_query($db,$sql);

                                $sql2="SELECT * FROM users_orders  where province like '$province' and unique_code in (SELECT unique_code from request_medication_01 where chronic_medication > 0)";
                                $query2=mysqli_query($db,$sql2);
                            }

                                if (!mysqli_num_rows($query) > 0) {
                                    echo '<td colspan="8"><center>No Chronic Patients -Data!</center></td>';
                                }
                                    else
                                {
