        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-secondary">List of all violations recorded today</h3> 
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Household Violations - today </h4>
...
<?php
    ...
    if(!mysqli_num_rows($query) > 0 ){
        echo '<td colspan="8"><center>No Violations Recorded Today!</center></td>';
    } else {				
