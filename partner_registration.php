                      ...
                      <div class="widget">
                        ...
                        <form action="" method="post">
                          ...
                          <div class="form-group col-md-12">
                            <label for="inputState">Partner Network</label>
                            <select id="inputState" class="form-control" name="organization_structure">
                          ...
                          <div class="form-group col-sm-6">
                            <label for="exampleInputFirstNames">Organization Name</label>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <select id="inputState" class="form-control" name="network">
                              ...
                              <option value="P">Civil Society Front</option>
