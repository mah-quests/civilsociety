...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
  ...
  VALUES
  ('".$_POST['username']."', '".$_POST['firstname']."', '".$_POST['lastname']."', '".$_POST['email']."', '".$_POST['phone']."', '".md5($_POST['password'])."', '".$_POST['address']."' ,'".$_POST['district']."', '".$_POST['municipality']."' ,'".$_POST['provice']."', '".$_POST['sex']."', '".$_POST['alt_person']."', '".$_POST['alt_number']."', 'P', '".$_POST['organization_structure']."', '".$_POST['organization_name']."', '".$_POST['nationality']."')";
   ...
   <div class="page-wrapper">
      ...
      <section class="contact-page inner-page">
         <div class="container">
            ...
            <?php  include_once('forms/partner_registration_form.php'); ?>
