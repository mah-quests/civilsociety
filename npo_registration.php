...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
  ...
  VALUES
  ('".$_POST['username']."', '".$_POST['firstname']."', '".$_POST['lastname']."', '".$_POST['email']."', '".$_POST['phone']."', '".md5($_POST['password'])."', '".$_POST['address']."' ,'".$_POST['district']."', '".$_POST['municipality']."' ,'".$_POST['provice']."', '".$_POST['sex']."', '".$_POST['alt_person']."', '".$_POST['alt_number']."', '".$_POST['network']."', '".$_POST['organization_structure']."', '".$_POST['organization_name']."', '".$_POST['nationality']."')";
        ...
        <div class="page-wrapper">
         ...
         <div class="page-wrapper">
            <div class="breadcrumb">
              <h3 align="center">Our NPO Partners Registration</h3>
               <div class="container">
                  <ul>
                     <li>
                      <a href="#" class="active">
                      ...
                      <div class="widget">
                        ...
                        <form action="" method="post">
                          ...
                          <div class="form-group col-sm-6">
                            <label for="exampleInputFirstNames">NPO Registration Number</label>
                              <input class="form-control" type="text" name="organization_structure" id="example-text-input" placeholder="Enter Organization Name" required>
                          </div>                             
                          <div class="form-group col-sm-6">
                            <label for="exampleInputFirstNames"> NPO Registered Name</label>
                              <input class="form-control" type="text" name="organization_name" id="example-text-input" placeholder="Enter Organization Name" required>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="inputState">Network</label>
                            <select id="inputState" class="form-control" name="network">
                              <option selected>Select...</option>
                              <option value="N">Civil Society Front</option>
                              <option value="N">Non Profit Organization</option>
