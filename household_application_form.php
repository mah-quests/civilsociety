...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
     if(!empty($_POST['firstname']) &   //fetching and find if its empty
        ...
        !empty($_POST['patient3_id']) &
        !empty($_POST['patient3_fullnames']) &
        !empty($_POST['patient3_facility']) &
...
(unique_code, chronic_medication, diabetesCondition, cancerCondition, heartCondition, highBloodCondition, hivCondition, tbCondition, patient1_id, patient1_fullnames, patient1_facility, patient2_id, patient2_fullnames, patient2_facility, patient3_id, patient3_fullnames, patient3_facility, essential_services_worker, healthCareCondition, disasterCondition, retailCondition, emegencyCondition, transportCondition, covid_signs, highTempCond, dryCoughCond, soreThroatConditionCond, diarrhoeaCondition, more_covid_info) 
VALUES
('".$reference."', '".$_POST['chronic_medication']."', '".$_POST['diabetesCondition']."', '".$_POST['cancerCondition']."', '".$_POST['heartCondition']."', '".$_POST['highBloodCondition']."', '".$_POST['hivCondition']."', '".$_POST['tbCondition']."', '".$_POST['patient1_id']."', '".$_POST['patient1_fullnames']."', '".$_POST['patient1_facility']."', '".$_POST['patient2_id']."', '".$_POST['patient2_fullnames']."', '".$_POST['patient2_facility']."', '".$_POST['patient3_id']."', '".$_POST['patient3_fullnames']."', '".$_POST['patient3_facility']."', '".$_POST['healthCareCondition']."', '".$_POST['essential_services_worker']."' , '".$_POST['disasterCondition']."',  '".$_POST['retailCondition']."', '".$_POST['emegencyCondition']."', '".$_POST['transportCondition']."', '".$_POST['covid_signs']."', '".$_POST['highTempCond']."' , '".$_POST['dryCoughCond']."', '".$_POST['soreThroatConditionCond']."', '".$_POST['diarrhoeaCondition']."', '".$_POST['more_covid_info']."')";


$mql_emp = "INSERT INTO house_employment_status
         ...
         <div class="page-wrapper">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-sm-12">
                            <label for="exampleInputIDNumber">Any form of identification</label>
                              <input class="form-control" type="text" name="identification" id="example-text-input" placeholder="ID Number" required> 
            ...
            <div class="form-group col-md-12" align="center">
              <h5>Household questionares</h5>
                    ...
                    <div class="form-group col-md-12">
                      <label for="inputState">Age composition</label>
                    </div>
